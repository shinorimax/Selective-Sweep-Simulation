...
## Analysis
This directory contains R scripts for analysis in `phylodyn`.
...
## Simulation
This directory contains Python scripts for running simulations.

- **`run.py`**: Simulates different scenarios and extracts trees at four genomic positions.
- **`genomic_position.py`**: Simulates a singular chromosome and saves results with position data.
- 
