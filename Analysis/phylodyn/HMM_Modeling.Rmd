...
```{r}
all_files <- list.files("/Users/yagishinnosuke/Documents/2024-2025 Stanford/Research/Selective-Sweep-Simulation/Results/Two_Sample_Test_ARG", pattern = "\\.csv$", full.names = TRUE)
...
```{r}
saveRDS(all_chromosomes, "/Users/yagishinnosuke/Documents/2024-2025 Stanford/Research/Selective-Sweep-Simulation/Results/Two_Sample_Test_ARG/all_chromosomes_grouped.rds")
```
...
saveRDS(
  all_trees,
  file = "/Users/yagishinnosuke/Documents/2024-2025 Stanford/Research/Selective-Sweep-Simulation/Results/Two_Sample_Test_ARG/all_trees_with_Fmat.rds"
)

message(sprintf("✅ Done! Total trees processed: %d", counter))
```
...
E_val <- compute_emission_matrix(F_val_list, F_0, F_1, beta_0 = 0.001, beta_1 = 0.0005)
```
