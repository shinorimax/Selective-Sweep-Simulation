...
```{r}
saveRDS(all_chromosomes, "/Users/yagishinnosuke/Documents/2024-2025 Stanford/Research/Selective-Sweep-Simulation/Results/SelectedTreesWithPositions/all_chromosomes_grouped.rds")
```
...
saveRDS(
  all_trees,
  file = "/Users/yagishinnosuke/Documents/2024-2025 Stanford/Research/Selective-Sweep-Simulation/Results/all_trees_with_Fmat.rds"
)
...
E_val <- compute_emission_matrix(F_val_list, F_0, F_1, beta_0 = 0.001, beta_1 = 0.002)
```
