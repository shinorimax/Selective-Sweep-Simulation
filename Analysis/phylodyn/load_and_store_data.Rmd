...
data_dir <- "../../Simulation/Slim(primary)/trees_newick/"
...
selective_s0.01_f0.25_prefix <- "^r404.*\\.tree$"
selective_s0.01_f0.5_prefix  <- "^r405.*\\.tree$"
selective_s0.01_f0.75_prefix <- "^r406.*\\.tree$"
...
read_and_save <- function(pattern_name, prefix) {
  ...
  saveRDS(obj, file = file.path("data2", paste0(pattern_name, ".rds")))
  cat("  Saved ->", file.path("data2", paste0(pattern_name, ".rds")), "\n\n")
...
```{r}
# --- Example -----------------------------------------------------------------
Fs_neutrals <- compute_and_save_Fs_nested(neutrals, "neutrals", out_dir = "data2")
Fs_s0.02_f0.25 <- compute_and_save_Fs_nested(selectives_s0.02_f0.25, "selectives_s0.02_f0.25", out_dir = "data")
Fs_s0.02_f0.5  <- compute_and_save_Fs_nested(selectives_s0.02_f0.5,  "selectives_s0.02_f0.5", out_dir = "data")
Fs_s0.02_f0.75 <- compute_and_save_Fs_nested(selectives_s0.02_f0.75, "selectives_s0.02_f0.75", out_dir = "data")

Fs_s0.01_f0.25 <- compute_and_save_Fs_nested(selectives_s0.01_f0.25, "selectives_s0.01_f0.25", out_dir = "data")
Fs_s0.01_f0.5  <- compute_and_save_Fs_nested(selectives_s0.01_f0.5,  "selectives_s0.01_f0.5", out_dir = "data")
Fs_s0.01_f0.75 <- compute_and_save_Fs_nested(selectives_s0.01_f0.75, "selectives_s0.01_f0.75", out_dir = "data")

Fs_s0.003_f0.25 <- compute_and_save_Fs_nested(selectives_s0.003_f0.25, "selectives_s0.003_f0.25", out_dir = "data")
Fs_s0.003_f0.5  <- compute_and_save_Fs_nested(selectives_s0.003_f0.5,  "selectives_s0.003_f0.5", out_dir = "data")
Fs_s0.003_f0.75 <- compute_and_save_Fs_nested(selectives_s0.003_f0.75, "selectives_s0.003_f0.75", out_dir = "data")

Fs_s0.001_f0.25 <- compute_and_save_Fs_nested(selectives_s0.001_f0.25, "selectives_s0.001_f0.25", out_dir = "data")
Fs_s0.001_f0.5  <- compute_and_save_Fs_nested(selectives_s0.001_f0.5,  "selectives_s0.001_f0.5", out_dir = "data")
Fs_s0.001_f0.75 <- compute_and_save_Fs_nested(selectives_s0.001_f0.75, "selectives_s0.001_f0.75", out_dir = "data")
# Now:
...
F_empirical_kingman <- compute_empirical_kingman_2(F_weighted_neutrals, output_path = "data/F_empirical_kingman.rds")
```
...
# FWs_neutrals <- compute_and_save_FWs_nested(neutrals, "neutrals", out_dir = "data")
# 
# # s = 0.02
# selectives_s0.02_f0.25 <- readRDS("data/selectives_s0.02_f0.25.rds")
# FWs_selectives_s0.02_f0.25 <- compute_and_save_FWs_nested(selectives_s0.02_f0.25, "selectives_s0.02_f0.25", out_dir = "data")
# 
# selectives_s0.02_f0.5 <- readRDS("data/selectives_s0.02_f0.5.rds")
# FWs_selectives_s0.02_f0.5 <- compute_and_save_FWs_nested(selectives_s0.02_f0.5, "selectives_s0.02_f0.5", out_dir = "data")
# 
# selectives_s0.02_f0.75 <- readRDS("data/selectives_s0.02_f0.75.rds")
# FWs_selectives_s0.02_f0.75 <- compute_and_save_FWs_nested(selectives_s0.02_f0.75, "selectives_s0.02_f0.75", out_dir = "data")
# 
# # s = 0.01
# selectives_s0.01_f0.25 <- readRDS("data/selectives_s0.01_f0.25.rds")
# FWs_selectives_s0.01_f0.25 <- compute_and_save_FWs_nested(selectives_s0.01_f0.25, "selectives_s0.01_f0.25", out_dir = "data")

selectives_s0.01_f0.5 <- readRDS("data/selectives_s0.01_f0.5.rds")
FWs_selectives_s0.01_f0.5 <- compute_and_save_FWs_nested(selectives_s0.01_f0.5, "selectives_s0.01_f0.5", out_dir = "data")

selectives_s0.01_f0.75 <- readRDS("data/selectives_s0.01_f0.75.rds")
FWs_selectives_s0.01_f0.75 <- compute_and_save_FWs_nested(selectives_s0.01_f0.75, "selectives_s0.01_f0.75", out_dir = "data")

# s = 0.003
selectives_s0.003_f0.25 <- readRDS("data/selectives_s0.003_f0.25.rds")
FWs_selectives_s0.003_f0.25 <- compute_and_save_FWs_nested(selectives_s0.003_f0.25, "selectives_s0.003_f0.25", out_dir = "data")

selectives_s0.003_f0.5 <- readRDS("data/selectives_s0.003_f0.5.rds")
FWs_selectives_s0.003_f0.5 <- compute_and_save_FWs_nested(selectives_s0.003_f0.5, "selectives_s0.003_f0.5", out_dir = "data")

selectives_s0.003_f0.75 <- readRDS("data/selectives_s0.003_f0.75.rds")
FWs_selectives_s0.003_f0.75 <- compute_and_save_FWs_nested(selectives_s0.003_f0.75, "selectives_s0.003_f0.75", out_dir = "data")

# s = 0.001
selectives_s0.001_f0.25 <- readRDS("data/selectives_s0.001_f0.25.rds")
FWs_selectives_s0.001_f0.25 <- compute_and_save_FWs_nested(selectives_s0.001_f0.25, "selectives_s0.001_f0.25", out_dir = "data")

selectives_s0.001_f0.5 <- readRDS("data/selectives_s0.001_f0.5.rds")
FWs_selectives_s0.001_f0.5 <- compute_and_save_FWs_nested(selectives_s0.001_f0.5, "selectives_s0.001_f0.5", out_dir = "data")

selectives_s0.001_f0.75 <- readRDS("data/selectives_s0.001_f0.75.rds")
FWs_selectives_s0.001_f0.75 <- compute_and_save_FWs_nested(selectives_s0.001_f0.75, "selectives_s0.001_f0.75", out_dir = "data")
```
...
FW_empirical_kingman <- compute_empirical_kingman_2(FW_weighted_neutrals, output_path = "data/FW_empirical_kingman.rds")
```
