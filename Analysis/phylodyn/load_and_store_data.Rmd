...
selective_s0.01_f0.75_prefix <- "^r401.*\\.tree$"
...
# --- Load and save data -----------------------------------------------------
neutrals <- read_and_save("neutrals_n10", neutral_prefix)
...
selectives_s0.01_f0.75 <- read_and_save("selectives_n10_s0.01_f0.75", selective_s0.01_f0.75_prefix)
...
```{r}
# --- Example -----------------------------------------------------------------
Fs_neutrals <- compute_and_save_Fs_nested(neutrals, "neutrals_n10")
...
Fs_s0.01_f0.75 <- compute_and_save_Fs_nested(selectives_s0.01_f0.75, "selectives_n10_s0.01_f0.75")
...
# Fs_s0.003_f0.75 <- compute_and_save_Fs_nested(seulectives_s0.003_f0.75, "selectives_s0.003_f0.75")
# 
...
# Neutral
Fs_nested_neutrals <- readRDS("data/Fs_nested_neutrals_n10.rds")
F_weighted_neutrals <- compute_weighted_Fs(
  Fs_nested = Fs_nested_neutrals,
  breaks_dir = data_dir,
  output_name = "F_weighted_average_neutrals_n10.rds",
  store_dir = "data"
)
...
Fs_nested_selectives_s0.01_f0.75 <- readRDS("data/Fs_nested_selectives_n10_s0.01_f0.75.rds")
F_weighted_selectives_s0.01_f0.75 <- compute_weighted_Fs(
  Fs_nested = Fs_nested_selectives_s0.01_f0.75,
  breaks_dir = data_dir,
  output_name = "F_weighted_average_selectives_n10_s0.01_f0.75.rds",
  store_dir = "data"
)
